<section class="container my-5">
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center mb-5 fw-bold bg-warning-subtle py-2">Buy Now</h2>
        </div>
    </div>
            ...
            <div class="col-md-8 bookcard">
                ...
                <div class="col-12">
                    <div class="row align-items-center border-bottom py-3">
                        <!-- Book Image -->
                        <div class="col-md-2">
                            <img src="public/images/book_name/<?php echo htmlspecialchars($book['book_image']); ?>" alt="<?php echo htmlspecialchars($book['book_name']); ?>" class="img-fluid" style="max-width:100px; max-height: 150px; min-width: 90px;">
                            <br>
                            <a href="#" class="text-black text-opacity-50 fw-light">Save for later</a>
                        </div>
                        <!-- Book Information -->
                        <div class="col-md-3" id="book-container-<?php echo htmlspecialchars($book['book_id']); ?>" data-book-price="<?php echo htmlspecialchars($book['book_price']); ?>" data-book-id="<?php echo htmlspecialchars($book['book_id']); ?>">
                            <h5 class="mb-2"><?php echo htmlspecialchars($book['book_name']); ?></h5>
                            <p class="mb-0">
                        ...
                        <div class="col-md-2 ps-5">
                            <input type="number" class="form-control" id="quantity-<?php echo htmlspecialchars($book['book_id']); ?>" min="1" value="1" onchange="updateQuantityBuyNow(<?php echo htmlspecialchars($book['book_id']); ?>, this.value)">
                        </div>
                        <!-- Total Price of Book Item -->
                        <div class="col-md-2 ps-5" id="total-price-<?php echo htmlspecialchars($book['book_id']); ?>">
                            <p class="mb-0" data-book-item-price="<?php echo htmlspecialchars($book['book_price']); ?>">
                                $<?php echo htmlspecialchars($book['book_price']); ?>
                            </p>
                        </div>
                        <!-- Remove Button -->
                        <div class="col-md-2 ps-5">
                            <button class="btn btn-danger opacity-75" onclick="removeFromBuyNow(<?php echo htmlspecialchars($book['book_id']); ?>)">
