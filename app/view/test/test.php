                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 bookcard">
                            <?php foreach ($books as $book) : ?>
                                <!-- Book id -->
                                <input type="hidden" name="book-id" id="book-id" value="<?php echo htmlspecialchars($book['book_id']) ?>">
                                <div class="col-12 ">
                                    <div class="row align-items-center border-bottom py-3">
                                        ...
                                        <div class="col-md-2  ps-5">
                                            <input type="number" class="form-control " min="1" value="<?php echo htmlspecialchars($book['quantity']); ?>" onchange="updateQuantity(<?php echo htmlspecialchars($book['book_id']); ?>, this.value)">
                                        </div>
